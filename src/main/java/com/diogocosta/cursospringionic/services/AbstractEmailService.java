...
public abstract class AbstractEmailService implements EmailService {
	...
	protected String htmlFromTemplatePedido(Pedido obj) {
		...
		context.setVariable("pedido", obj); // variável a ser utilizada pelo template do thymeleaf para preencher os campos
				
		return templateEngine.process("email/confirmacaoPedido", context); // retorna a página do thymeleaf preenchida com o objeto contexto
